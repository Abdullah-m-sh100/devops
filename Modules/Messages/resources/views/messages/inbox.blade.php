<x-app-layout>
    <x-slot name="header"><div class="flex items-center justify-between"><h2 class="font-semibold text-xl text-gray-800 leading-tight">Inbox</h2><a href="{{ route('messages.create') }}" class="px-4 py-2 bg-gray-900 text-white rounded-md">Compose</a></div></x-slot>
    <div class="py-8"><div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        @include('messages::messages.list', ['messages' => $messages, 'mode' => 'inbox'])
    </div></div>
</x-app-layout>
